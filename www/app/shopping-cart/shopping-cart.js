angular.module('app.shoppingCart', []).config(function ($stateProvider) {
  ...
  .controller('ShoppingCartCtrl', function ($scope, $log, $ionicSideMenuDelegate, $timeout, localStorageService, shoppingCart, $ionicModal, Customer, newOrder, $ionicLoading, $ionicContentBanner, $state) {
    $scope.data = {};
